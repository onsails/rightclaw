...
**v3.1 in progress** — Phase 29 complete (2026-04-02): Sandbox dependency fix. System `rg` path injected into CC sandbox settings.json, `USE_BUILTIN_RIPGREP` polarity fixed to `"0"`, `failIfUnavailable: true` added, ripgrep added to devenv.nix. All 4 SBOX requirements validated.
