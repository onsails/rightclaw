...
- [x] **BOT-05**: `allowed_chat_ids` field in agent.yaml — messages from unlisted chat IDs are silently ignored
...
- [x] **PROMPT-03**: `codegen/shell_wrapper.rs` removed — shell wrappers are no longer generated by `rightclaw up`
