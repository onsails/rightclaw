...
- `tunnel_uuid()` method: decodes single-segment (real CF token) or 3-segment JWT, returns raw UUID (e.g. `aaaabbbb-0000-1111-2222-ccccddddeeee`) — no `.cfargotunnel.com` suffix
