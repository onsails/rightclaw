...
```json
{
  "AccountTag": "...",
  "TunnelSecret": "...",
  "TunnelID": "aaaabbbb-0000-1111-2222-ccccddddeeee",
  "Endpoint": ""
}
```

Reading `TunnelID` directly from the JSON replaces the JWT base64-decode logic (`tunnel_uuid()` method). [VERIFIED: local `~/.cloudflared/aaaabbbb-0000-1111-2222-ccccddddeeee.json` field names confirmed]
...
| credentials JSON | `rightclaw init --tunnel-credentials-file` | Yes (`~/.cloudflared/aaaabbbb-0000-1111-2222-ccccddddeeee.json`) | — | User must run `cloudflared tunnel create` |
...
- `~/.cloudflared/aaaabbbb-0000-1111-2222-ccccddddeeee.json` — credentials JSON field names verified locally
